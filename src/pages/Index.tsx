		...
		<Layout>
			<section className="relative min-h-[80vh] flex items-center">
				...
				<div className="container relative z-10 mx-auto px-4 py-20 lg:py-28">
					<div className="max-w-2xl bg-background/90 backdrop-blur-sm rounded-xl p-6 md:p-8 lg:p-10 shadow-xl">
						<div className="space-y-6">
							...
							<div className="bg-muted/50 rounded-lg p-4 md:p-6 space-y-3">
								<h2 className="text-lg md:text-xl font-semibold">Our mission is simple but powerful:</h2>
							...
							<div className="space-y-3">
								<p className="font-medium text-sm md:text-base">Get started today:</p>
								...
								<Button asChild variant="link" size="lg" className="px-0 text-foreground">
